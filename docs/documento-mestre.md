...
- Na primeira visita, uma modal informa que o Pronto! usa apenas cookies essenciais para a sessão, guarda preferências da interface no navegador e não usa cookies de publicidade. Ela oferece acesso à Política de privacidade e permite aceitar e continuar; o reconhecimento fica salvo somente no navegador. Essa ciência informativa não substitui a ciência institucional da política exigida para contas.
