...
- A implantação inicial usa o plano Vercel Hobby e a URL pública `https://prontobib.vercel.app`.
...
- Em assistência excepcional, o Administrador pode conferir a situação da conta, orientar e solicitar ou reenviar o fluxo oficial de recuperação. Nunca visualiza, solicita ou define uma senha conhecida por ele, não dispensa a confirmação de novo e-mail e deve ter suas ações administrativas relevantes registradas em log.
