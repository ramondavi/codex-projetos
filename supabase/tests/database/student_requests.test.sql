...
values
  ('30000000-0000-4000-8000-000000000001', 'teste.solicitacao1@ufba.br', now(), '{"registration_source":"student","full_name":"Estudante Solicitação Um","cpf":"52998224725"}'::jsonb),
  ('30000000-0000-4000-8000-000000000002', 'teste.solicitacao2@ufba.br', now(), '{"registration_source":"student","full_name":"Estudante Solicitação Dois","cpf":"11144477735"}'::jsonb);
