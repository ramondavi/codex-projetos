...
test("shared shell greets the user and footer publishes version, credits and source",()=>{assert.match(shell,/Olá, \{firstName\}/);assert.match(footer,/Beta/);assert.match(footer,/Ramon Santana/);assert.match(footer,/Codex/);assert.match(footer,/github\.com\/ramondavi\/codex-projetos/)});
