...
export default function PrivacyNoticePage() {
  return <><SiteHeader /><main className="privacy-page">
    <header className="container privacy-hero">
      <p className="eyebrow">Política de privacidade · versão 1.0 · última atualização: 21 de setembro de 2026</p><h1>Privacidade, em linguagem clara.</h1>
    ...
    <section className="container privacy-accordion" aria-label="Detalhes da política de privacidade">
      ...
      <details><summary><span>02</span><strong>Responsáveis, base legal e contato</strong><b aria-hidden="true">+</b></summary><div><p><strong>Controladora:</strong> Universidade Federal da Bahia (UFBA), por meio da Biblioteca da Faculdade de Arquitetura.</p><p><strong>Canal do serviço:</strong> <ProtectedEmail recipient="library" />. <strong>Encarregada de Dados da UFBA:</strong> Ana Cláudia Caldas Mendonça Semêdo; canal institucional: <ProtectedEmail recipient="privacy" />.</p><p>Informações institucionais sobre proteção de dados estão disponíveis na <a href="https://lgpd.ufba.br/" target="_blank" rel="noreferrer">página de LGPD da UFBA</a>.</p><p>O tratamento fundamenta-se no cumprimento de obrigação legal ou regulatória e atende à finalidade pública de prestar o serviço bibliotecário da UFBA.</p></div></details>
