  ...
  return (
    <main className="dashboard-main dashboard-main--narrow">
      ...
      <section className="panel account-settings">
        ...
        <p>A alteração só será concluída depois das confirmações de segurança enviadas pelo Supabase.</p>
        <AuthFeedback error={error} message={message} />
        <form className="form-stack" action={requestEmailChange}>
          <label>Novo e-mail @ufba.br<input type="email" name="email" autoComplete="email" placeholder="seunome@ufba.br" required /></label>
          <button className="button button--secondary" type="submit">Solicitar alteração</button>
        </form>
      </section>
    </main>
  );
