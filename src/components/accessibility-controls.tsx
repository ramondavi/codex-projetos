    ...
    <nav className="accessibility-bar" aria-label="Recursos de acessibilidade">
      <div className="container accessibility-bar__inner">
        <div className="accessibility-bar__links">
          ...
          <button type="button" onClick={changeContrast} accessKey="3" aria-pressed={highContrast} aria-label="Alternar alto contraste" title="Alto contraste">Contraste <span aria-hidden="true">[3]</span></button>
          <a href="/ajuda" accessKey="4">Central de ajuda <span aria-hidden="true">[4]</span></a>
