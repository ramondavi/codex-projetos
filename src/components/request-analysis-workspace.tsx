...
export function RequestAnalysisWorkspace({ requestId, initialAnalysisNotes, initialInternalNote, editable }: { requestId: string; initialAnalysisNotes: string; initialInternalNote: string; editable: boolean }) {
