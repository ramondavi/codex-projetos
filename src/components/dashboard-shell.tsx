    ...
    <div className={`dashboard-shell${compact ? " dashboard-shell--compact" : ""}`}>
      <aside className={`dashboard-nav${compact ? " dashboard-nav--compact" : ""}`}>
        <div className="dashboard-nav__top">
          {compact ? <span className="dashboard-nav__favicon"><Image src="/icon.png" alt="Pronto!" width={64} height={64} priority /></span> : <span className="dashboard-nav__brand-logo"><Image className="brand__image brand__image--light" src="/logo-pronto-light.png" alt="Pronto!" width={1600} height={643} priority /><Image className="brand__image brand__image--dark" src="/logo-pronto-dark.png" alt="Pronto!" width={1600} height={643} priority /></span>}
        </div>
        <button className="dashboard-nav__rail-toggle" type="button" onClick={() => setCompact((current) => !current)} aria-label={compact ? "Expandir menu lateral" : "Compactar menu lateral"} title={compact ? "Expandir menu" : "Compactar menu"}><SidebarIcon name={compact ? "panelExpand" : "panelCollapse"} /></button>
